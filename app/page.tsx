...
export default function Home() {
  return (
    <main className="flex items-center justify-center main-height">
      <ParticlesBg />
      <div className="flex flex-col h-2/3 w-2/3 lg:w-[680px] p-12 text-white text-opacity-50 text-xl sm:text-2xl text-center overflow-hidden">
        <p>
        ...
        <button className="rounded-2xl px-2 self-center mt-auto text-white">
